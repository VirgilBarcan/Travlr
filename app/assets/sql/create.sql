...
ALTER TABLE Flight ADD CONSTRAINT Flight_Address_FK FOREIGN KEY ( src ) REFERENCES Address ( address_id ) ;

ALTER TABLE Flight ADD CONSTRAINT Flight_Address_FKv1 FOREIGN KEY ( dst ) REFERENCES Address ( address_id ) ;

ALTER TABLE User_Trip ADD CONSTRAINT Trip_FK FOREIGN KEY ( trip ) REFERENCES Trip ( trip_id ) ;

ALTER TABLE Trip_Flight ADD CONSTRAINT Trip_Flight_Flight_FK FOREIGN KEY ( Flight_flight_id ) REFERENCES Flight ( flight_id ) ;

ALTER TABLE Trip_Flight ADD CONSTRAINT Trip_Flight_Trip_FK FOREIGN KEY ( Trip_trip_id ) REFERENCES Trip ( trip_id ) ;
...
ALTER TABLE User_Preference ADD CONSTRAINT User_FK FOREIGN KEY ( "user" ) REFERENCES "User" ( user_id ) ;
